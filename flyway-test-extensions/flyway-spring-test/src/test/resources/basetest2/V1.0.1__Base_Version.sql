...
CREATE INDEX CUS_CUS_ID_I ON CUSTOMER2(CUS_ID) ;
ALTER TABLE CUSTOMER2 ADD CONSTRAINT CUS_ID_PK PRiMARY KEY (CUS_ID);
ALTER TABLE CUSTOMER2 ADD CONSTRAINT CUS_NAME_UK UNIQUE (CUS_NAME);
