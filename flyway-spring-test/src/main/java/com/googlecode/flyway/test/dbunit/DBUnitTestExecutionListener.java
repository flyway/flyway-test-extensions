...
/**
 * A {@link TestExecutionListeners} to get the annortation {@link DBUnitSupport}
 * up and running.</p>
 * 
 ...
 * {@link com.googlecode.flyway.test.annotation.FlywayTest} are used the system
...
public class DBUnitTestExecutionListener implements TestExecutionListener {
	...
	/**
	 * Get the dbuint specific database connection
	 * 
	 * @param dataSource
	 * @return
	 * @throws Exception
	 ...
	 */
	private DataSource getBean(ApplicationContext context, Class<?> _class) {
